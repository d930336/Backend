...
class Coupon(models.Model):
    ...
    coupon_original_price = models.IntegerField(blank=True,null=True)
    ...
    coupon_saving = models.IntegerField()
    coupon_img = models.ImageField(upload_to='coupons', blank=True,null=True)
    coupon_create_at = models.DateTimeField(auto_now_add=True)
...
class UserAccounting(models.Model):
    ...
    accounting_discount = models.CharField(max_length=30,blank=True,null=True)
    accounting_coupon_name = models.CharField(max_length=50,blank=True,null=True)
